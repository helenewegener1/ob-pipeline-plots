...
output_dir <- "Documents/courses/Benchmarking/repos/ob-pipeline-plots/NewNames_fig2"
...
valid_datasets <- c("covidPBMC_flow", "ChikVirusPBMC_Cyt", "HumanBoneMarrow_flow", "HumanBoneMarrow_Cyt", "MouseBoneMarrow_Cyt", "StimBlood_Cyt")
